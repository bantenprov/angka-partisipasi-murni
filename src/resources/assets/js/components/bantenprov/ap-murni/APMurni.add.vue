...
export default {
    ...
    methods: {
              ...
              if(this.model.tahun >= 2000 && this.model.tahun <= (new Date()).getFullYear())
              {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/ap-murni/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/ap-murni/create'
                  }
                },
                window.location.href = '#/admin/ap-murni/create')
        ...
        back() {
            window.location = '#/admin/ap-murni';
        }
    },
    mounted: function() {
        axios.get("/ap-murni/create").then(response => {
